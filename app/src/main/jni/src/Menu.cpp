...
titleValid = true;
return env->NewStringUTF(OBFUSCATE("Modded by Abm"));
}
...
Java_uk_lgl_modmenu_FloatingModMenuService_Heading(JNIEnv *env, jobject thiz) {
    headingValid = true;
    return env->NewStringUTF(OBFUSCATE("0x0110"));
}
...
Java_uk_lgl_modmenu_FloatingModMenuService_getFeatureList(JNIEnv *env, jobject activityObject) {
    ...
    const char *features[] = {
            OBFUSCATE("Category_Coin Master Mod Menu"),
            OBFUSCATE("Toggle_Max Send Card"),
            OBFUSCATE("Toggle_Unlock all cards"),
           // OBFUSCATE("SeekBar_Custom Send Card_0_500"),
    };
